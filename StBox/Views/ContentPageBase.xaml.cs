...
using StBox.ViewModels.AppNavigation;
using StBox.Views.Contracts;
using StBox.Views.Controls;
using StBox.Views.Controls.ActionBars;
using StBox.Views.Controls.ActionBars.Base;
using StBox.Views.Controls.Popups;
using System;
...
namespace StBox.Views
{
    ...
    public partial class ContentPageBase : ContentPage
    {
        ...
        protected override void OnBindingContextChanged()
        {
            ...
            if (!(BindingContext is ContentPageBaseViewModel))
            {
                Console.WriteLine($"WARNING: `ContentPageBase control` expects `ContentPageBaseViewModel` binding context. Current context is `{BindingContext?.GetType().FullName}`");
            }
        }
        ...
        protected override void OnDisappearing()
        {
            ...
            if (BindingContext is IHandlePageVisualCycles)
            {
                ((IHandlePageVisualCycles)BindingContext).OnPageDisappearing();
            }
        }
        ...
        protected override void OnAppearing()
        {
            ...
            if (BindingContext is IHandlePageVisualCycles)
            {
                ((IHandlePageVisualCycles)BindingContext).OnPageAppearing();
            }
        }
    }
}